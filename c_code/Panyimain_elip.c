...
GSParams *parse_args(unsigned int argc, char **argv) {
    ...
    params->ampO = 0;
    params->phiRef = 0.0;
    params->deltaT = 1./(4 * 4096);
    params->m1 = 36 * LAL_MSUN_SI;
    params->m2 = 31 * LAL_MSUN_SI;
    params->f_min = 10;
    params->f_max = 1000;
    params->e0 = 0.;
    params->distance = 430. * 1e6 * LAL_PC_SI;
    ...
    strncpy(params->outname, "simulation_attempt.dat", 256); /* output to this file */
